...
import React__default, { useContext, createContext, useRef, useLayoutEffect as useLayoutEffect$1, useEffect, lazy, Suspense } from 'react';
...
const genCSSVarRegister = (component, getDefaultToken, options) => {
  ...
  const useCSSVar = rootCls => {
    ...
    return [node => injectStyle && cssVar ? ( /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(CSSVarRegister, {
      rootCls: rootCls,
      cssVar: cssVar,
      component: component
...
var LazyBox = lazy(function () { return import('./MessageList-D7SR7NjC.js'); });
var LazyWrappedComponent = function (props) { return (React__default.createElement(Suspense, { fallback: React__default.createElement("div", { style: {
            height: '100px',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
        } },
        React__default.createElement(Spin$1, { size: 'large', style: { display: 'inline-block' }, tip: 'Caricamento...' })) },
    React__default.createElement(LazyBox, __assign({}, props)))); };

export { getDefaultExportFromCjs as $, _toConsumableArray as A, useLayoutEffect as B, ConfigContext as C, removeCSS as D, merge$1 as E, get as F, set as G, _assertThisInitialized as H, IconContext as I, isEqual as J, Keyframe as K, LocaleContext$1 as L, CSSMotion as M, composeRef as N, fillRef as O, isDOM as P, wrapperRaf as Q, unit$1 as R, SizeContext$1 as S, resetComponent as T, devUseWarning as U, isValidElement as V, isFragment as W, cloneElement as X, clearFix as Y, DisabledContext$1 as Z, _inherits as _, _createSuper as a, gold as a0, omit as a1, LazyWrappedComponent as a2, _classCallCheck as b, _createClass as c, _objectSpread2 as d, _typeof as e, findDOMNode as f, _extends as g, useSafeState as h, _slicedToArray as i, useLayoutUpdateEffect as j, warningOnce as k, localeValues as l, generate as m, updateCSS as n, _objectWithoutProperties as o, blue as p, classNames as q, reactIsExports as r, supportRef as s, _defineProperty as t, useComposeRef as u, useToken as v, warning$2 as w, genStyleHooks as x, merge as y, canUseDom as z };
//# sourceMappingURL=index-CCprUAkR.js.map
