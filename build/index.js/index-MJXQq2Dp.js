...
let NumCalculator = /*#__PURE__*/function (_AbstractCalculator) {
  ...
  function NumCalculator(num) {
    ...
    _this = _callSuper$1(this, NumCalculator);
    _this.result = 0;
...
const fullClone = Object.assign({}, React__namespace);
const {
  useId
} = fullClone;
const useEmptyId = () => '';
...
const ProviderChildren = props => {
  ...
  const memoTheme = React__namespace.useMemo(() => {
    const _a = mergedTheme || {},
      ...
      rest = __rest$1(_a, ["algorithm", "token", "components", "cssVar"]);
...
// ============================== Export ==============================
var useStyle = genStyleHooks('Spin', token => {
...
const Spin = props => {
  ...
  const isNestedPattern = React__namespace.useMemo(() => typeof children !== 'undefined' && !fullscreen, [children, fullscreen]);
  if (process.env.NODE_ENV !== 'production') {
  ...
  const spinElement = /*#__PURE__*/React__namespace.createElement("div", Object.assign({}, divProps, {
    ...
    "aria-live": "polite",
    "aria-busy": spinning
  }), renderIndicator(prefixCls, props), tip && (isNestedPattern || fullscreen) ? ( /*#__PURE__*/React__namespace.createElement("div", {
    className: `${prefixCls}-text`
  }, tip)) : null);
  if (isNestedPattern) {
    return wrapCSSVar( /*#__PURE__*/React__namespace.createElement("div", Object.assign({}, divProps, {
...
var LazyBox = React.lazy(function () { return Promise.resolve().then(function () { return require('./MessageList-GAdLgb8_.js'); }); });
var LazyWrappedComponent = function (props) { return (React.createElement(React.Suspense, { fallback: React.createElement("div", { style: {
            height: '100px',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
        } },
        React.createElement(Spin$1, { size: 'large', style: { display: 'inline-block' }, tip: 'Caricamento...' })) },
    React.createElement(LazyBox, __assign({}, props)))); };

exports.CSSMotion = CSSMotion;
exports.ConfigContext = ConfigContext;
exports.DisabledContext = DisabledContext$1;
exports.IconContext = IconContext;
exports.Keyframe = Keyframe;
exports.LazyWrappedComponent = LazyWrappedComponent;
exports.LocaleContext = LocaleContext$1;
exports.SizeContext = SizeContext$1;
...
exports.localeValues = localeValues;
exports.merge = merge;
exports.merge$1 = merge$1;
exports.omit = omit;
...
exports.warning = warning$2;
exports.warningOnce = warningOnce;
exports.wrapperRaf = wrapperRaf;
//# sourceMappingURL=index-MJXQq2Dp.js.map
